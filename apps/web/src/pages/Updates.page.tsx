...
const entries: {
  ...
  {
    emoji: '🪙',
    title: "'동전 던지기' 미니게임 칸이 추가되었습니다",
    author: 'ATJSH',
    date: new Date('2022-05-14T21:51:00+09:00'),
    updates: [
      "동전 던지기의 결과를 예측하는 미니게임인 '동전 던지기 중급', '동전 던지기 고급' 칸이 추가되었습니다.",
      '최대 ₩2,560,000 어치를 벌 수 있답니다. 당신의 예측의 감을 시험해보세요.',
    ],
  },
  {
    emoji: '🚵‍♂️',
    title: "'동전 던지기 무한' 칸이 추가되었습니다",
    author: 'ATJSH',
    date: new Date('2022-05-15T01:00:00+09:00'),
    updates: [
      "'동전 던지기' 칸과 비슷하지만, 횟수 제한 없이 예측을 이어나갈 수 있는 '동전 던지기 무한' 칸이 추가되었습니다.",
    ],
  },
].reverse();
