...
import { MAP_TRANSITION_DURATION_MS } from '../map/map-status-bar.component';
  ...
  useEffect(() => {
    if (lastExposedSkillLogIndex == 0) {
      ...
      steps.map((step, index) =>
        ...
        }, [0, 700 + MAP_TRANSITION_DURATION_MS, 2400 + MAP_TRANSITION_DURATION_MS, 3600 + MAP_TRANSITION_DURATION_MS][index] ?? (index + 1) * 600),
      );
