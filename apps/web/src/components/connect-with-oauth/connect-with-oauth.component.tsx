    ...
    isCollapsed ? (
      ...
      <div className="bg-white rounded-3xl flex flex-col gap-3 py-7">
        ...
        <div className="flex flex-col px-3 gap-2 text-center">
          <a
            className="font-bold rounded-md py-2 transition-colors text-blue-500 border-2 border-blue-500 hover:bg-blue-500 hover:text-white active:bg-blue-700"
          ...
          <button
            className="text-gray-600 border border-gray-300 rounded-md px-3 py-1 hover:bg-gray-200 active:bg-gray-300 transition-colors hover:border-gray-400"
